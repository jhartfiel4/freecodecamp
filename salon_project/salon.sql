...
INSERT INTO public.appointments VALUES (28, 1, 2, '11am');
...
SELECT pg_catalog.setval('public.appointments_appointments_id_seq', 28, true);
...
SELECT pg_catalog.setval('public.customers_customers_id_seq', 1, true);
